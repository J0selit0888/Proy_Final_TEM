                    ...
                    <div>
                        <form action="Controlador?menu=Empleados" method="POST">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="txtdocumento" value="${usuarioSeleccionado.getCi()}">
                                <small class="form-text text-muted">Ingrese El Ci sin espacios ni caracteres especiales</small>
                            </div>
                            <div class="form-group">
                                <label>Nombre</label>
